...
import typistanPng from '../typistan.png';
...
app.get("/typistan.png", async (c) => {
  ...
  // base64 encode typistanPng which is an arraybuffer
  const imgBase64 = btoa(
    new Uint8Array(typistanPng).reduce((data, byte) => data + String.fromCharCode(byte), '')
  );
